...
public class AskOpenAiService implements AskLlmService {
    ...
    public AskOpenAiService(ChatClient chatClient, QuestionAwserAdvisorFactory questionAwserAdvisorFactory, SimpleLoggerAdvisor simpleLoggerAdvisor,
